...
public class ErrorUserLoginTestInventoryItemTest {
    ...
    public void setUp() {
        ...
        pages.loginObject.loginAsStandardUser("error_user");
    }
    ...
    public void testRemoveProductInCart(){
        try{
            ...
            throw new AssertionError("Element not found within the specified time");
        }
